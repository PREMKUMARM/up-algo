...
def highVolume():
    return ["MCDOWELL-N", "SHRIRAMFIN", "CANFINHOME", "ATUL", "RECLTD", "INDIAMART", "SRF", "COLPAL", "ITC", "RBLBANK", "POLYCAB", "CANBK", "SUNTV", "PFC", "IGL", "MPHASIS", "ASHOKLEY", "DIXON", "HDFCAMC", "NAVINFLUOR", "GLENMARK", "AUBANK", "BIOCON", "PETRONET", "PVRINOX", "IDEA"]
